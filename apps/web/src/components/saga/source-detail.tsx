...
/**
 * One source: what it is, how ingestion went, and where answers have cited it.
 *
 * Rendered by two routes. `/sources/{id}` is the page; the same URL reached from inside the
